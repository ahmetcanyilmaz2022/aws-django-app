...
DATABASES = {
    'default': {
        ...
        'HOST': 'capstone-rds.csj821jcw66i.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'capstones-acan-blog' # please enter your s3 bucket name
